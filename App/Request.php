...
class Request
{
    ...
    public function __construct()
    {
        ...
        $this->request = array_merge($_GET, $_POST, $_COOKIE, $_FILES, $decoded, $_SERVER);
        $this->server = $_SERVER;
    ...
    protected function getUser() {
        if($this->is_authenticated) {
            $user = \App\DB::run('SELECT * FROM users WHERE user_id = ?', [$_SESSION[App::getConfig('session_name')]])->fetch();
